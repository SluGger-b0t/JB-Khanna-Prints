...
const GiftItemsClient = ({ products }) => {
  // Filter products to only include those with collection 'gift items'
  const filteredByCollection = {}
  Object.entries(products).forEach(([category, items]) => {
    items.forEach((item, idx) => {
      // console.log(`Product in category '${category}' [${idx}]:`, item)
    })
  ...
  // console.log('Filtered by collection:', filteredByCollection)
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-sm sm:text-base md:text-lg text-[#2f4f4f]/80 mb-8 mt-8 w-full md:w-1/2 mx-auto">
              Introducing Our New Gift Items Collection! At JB Khanna Prints,
              we're excited to unveil our latest range of posters — a blend of
          ...
          <div className="w-full mb-8 overflow-x-auto sm:overflow-x-visible">
            <div className="flex flex-nowrap sm:flex-wrap justify-start sm:justify-center gap-2 sm:gap-4 px-2">
                    ...
                    onClick={(e) => {
                      ...
                      if (expandedCategory === category) {
                        ...
                        setDropdownPosition({
                          ...
                          left:
                            rect.left + rect.width / 2 - 96 + window.scrollX, // center align, 96 = w-48/2
                        })
                      }
                    }}
