...
import {
  ...
  usePortal,
  useToast
} from "./chunk-B3P257KD.js";
import {
  require_dist
} from "./chunk-OAXNU7CD.js";
import {
  require_jsx_runtime
...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources6-X2NUO3TW.js")
});
    ...
    $[43] !== documentTitle ? (t162 = {
      ...
      (0, import_jsx_runtime2.jsxs)(Box, { overflow: "auto", paddingTop: 2, children: [
        (0, import_jsx_runtime2.jsxs)(Table$1, { children: [
          ...
          (0, import_jsx_runtime2.jsx)("tbody", { children: crossDatasetReferences.references.filter(_temp$r).map((t172, index) => {
            const {
              projectId,
              datasetName,
              documentId
...
function useReferringDocuments(documentId) {
  ...
  let t5;
  $[8] !== (crossDatasetReferences == null ? void 0 : crossDatasetReferences.references) ? (t5 = () => Array.from(new Set(crossDatasetReferences == null ? void 0 : crossDatasetReferences.references.map(_temp$q).filter(Boolean))).sort(), $[8] = crossDatasetReferences == null ? void 0 : crossDatasetReferences.references, $[9] = t5) : t5 = $[9];
  let t6;
...
function _temp$q(crossDatasetReference) {
...
function PaneLayout(props) {
  ...
  const [controller] = (0, import_react2.useState)(_temp$p), [rootElement, setRootElement] = (0, import_react2.useState)(null), width = ((_a = useElementRect(rootElement)) == null ? void 0 : _a.width) || 0, collapsed = width === void 0 || !minWidth ? void 0 : width < minWidth;
  let t0;
...
function PaneHeaderCreateButton(t0) {
  ...
  let t3;
  t3 = !isTemplatePermissionsLoading && (templatePermissions == null ? void 0 : templatePermissions.every(_temp$o));
...
function MissingSchemaType(props) {
  ...
  let t6;
  return $[12] !== layout || $[13] !== t22 || $[14] !== t5 ? (t6 = (0, import_jsx_runtime2.jsx)(SanityDefaultPreview, { title: t22, subtitle: t5, media: _temp$n, layout }), $[12] = layout, $[13] = t22, $[14] = t5, $[15] = t6) : t6 = $[15], t6;
}
function _temp$n() {
...
function useDiffViewRouter() {
  ...
  $[3] !== navigate || $[4] !== routerState ? (t1 = () => {
    navigate({
      ...routerState,
      _searchParams: (routerState._searchParams ?? []).filter(_temp$m)
    });
...
function usePathSyncChannel(t0) {
  ...
  if ($[3] !== id || $[4] !== syncChannel) {
    ...
    $[6] !== id ? (t42 = (t5) => {
      ...
      return source !== id;
    }, $[6] = id, $[7] = t42) : t42 = $[7], t3 = syncChannel.pipe(distinctUntilChanged(_temp$k), filter(t42), map(_temp2$7)), $[3] = id, $[4] = syncChannel, $[5] = t3;
  } else
    t3 = $[5];
  t2 = t3;
  const path = t2;
...
var DiffViewDocument = (t0) => {
  ...
  const compareValue = useCompareValue(t1), [patchChannel] = (0, import_react2.useState)(_temp$j);
  let t2;
...
function useDocumentIdStack(t0) {
  ...
  let t6;
  $[11] !== releaseStack || $[12] !== systemStack ? (t6 = systemStack.concat(releaseStack).filter(_temp$i), $[11] = releaseStack, $[12] = systemStack, $[13] = t6) : t6 = $[13];
  const stack = t6;
  let t7;
...
function RequestPermissionDialog(t0) {
  const $ = (0, import_react_compiler_runtime.c)(56), {
    ...
    t: t2
  } = useTranslation2(structureLocaleNamespace), telemtry = useTelemetry(), dialogId = `request-permissions-${(0, import_react2.useId)()}`, projectId = useProjectId$1();
  let t1;
...
var CanvasPopoverContent = (t0) => {
  const $ = (0, import_react_compiler_runtime.c)(22), {
    ...
    t: t2
  } = useTranslation2(structureLocaleNamespace), ref = (0, import_react2.useRef)(null);
  let t1;
...
var CanvasLinkedBannerContent = (t0) => {
  const $ = (0, import_react_compiler_runtime.c)(17), {
    ...
    t: t2
  } = useTranslation2(structureLocaleNamespace), [open, setOpen] = (0, import_react2.useState)(false), documentVariantType = getDocumentVariantType(documentId);
  let t1;
  bb0: {
...
function CanvasLinkedBanner() {
  const $ = (0, import_react_compiler_runtime.c)(10), {
    ...
    t: t2
  } = useTranslation2(structureLocaleNamespace), id = (displayed == null ? void 0 : displayed._id) || documentId, {
    companionDoc
...
var FavoriteToggle = (t0) => {
  ...
  const {
    ...
    t: t2
  } = useTranslation2(structureLocaleNamespace), t1 = isFavorited ? "document.favorites.remove-from-favorites" : "document.favorites.add-to-favorites";
  let t22;
...
var DocumentPanel = function(props) {
  var _a;
  const $ = (0, import_react_compiler_runtime.c)(87), {
    footerHeight,
    headerHeight,
    isInspectOpen,
    rootElement,
  ...
  bb1: {
    ...
    if (isScheduledRelease && (displayed == null ? void 0 : displayed._id) && getVersionFromId(displayed == null ? void 0 : displayed._id) === selectedReleaseId) {
      const t143 = selectedPerspective;
      let t153;
      $[37] !== t143 ? (t153 = (0, import_jsx_runtime2.jsx)(ScheduledReleaseBanner, { currentRelease: t143 }), $[37] = t143, $[38] = t153) : t153 = $[38], t12 = t153;
      break bb1;
    }
    let t142;
    $[39] !== selectedPerspective ? (t142 = isSystemBundle(selectedPerspective), $[39] = selectedPerspective, $[40] = t142) : t142 = $[40];
    ...
    if ((displayed == null ? void 0 : displayed._id) && getVersionFromId(displayed._id) !== selectedReleaseId && ready && !isPinnedDraftOrPublish) {
      ...
      let t172;
      $[41] !== isScheduledRelease || $[42] !== t153 || $[43] !== t162 || $[44] !== value._id ? (t172 = (0, import_jsx_runtime2.jsx)(DocumentNotInReleaseBanner, { documentId: value._id, currentRelease: t153, value: t162, isScheduledRelease }), $[41] = isScheduledRelease, $[42] = t153, $[43] = t162, $[44] = value._id, $[45] = t172) : t172 = $[45], t12 = t172;
      break bb1;
    }
    if (activeView.type === "form" && isLiveEdit && ready && ((_a = editState == null ? void 0 : editState.draft) == null ? void 0 : _a._id) && !selectedReleaseId) {
      let t153;
      $[46] !== displayed || $[47] !== documentId || $[48] !== schemaType ? (t153 = (0, import_jsx_runtime2.jsx)(DraftLiveEditBanner, { displayed, documentId, schemaType }), $[46] = displayed, $[47] = documentId, $[48] = schemaType, $[49] = t153) : t153 = $[49], t12 = t153;
      break bb1;
    }
    ...
    let t152;
    $[50] !== showCreateBanner ? (t152 = showCreateBanner && (0, import_jsx_runtime2.jsx)(CreateLinkedBanner, {}), $[50] = showCreateBanner, $[51] = t152) : t152 = $[51];
    let t16;
    $[52] !== (permissions == null ? void 0 : permissions.granted) || $[53] !== requiredPermission ? (t16 = !(permissions == null ? void 0 : permissions.granted) && (0, import_jsx_runtime2.jsx)(InsufficientPermissionBanner, { requiredPermission }), $[52] = permissions == null ? void 0 : permissions.granted, $[53] = requiredPermission, $[54] = t16) : t16 = $[54];
    let t17, t18, t19, t20, t21, t22;
    $[55] === Symbol.for("react.memo_cache_sentinel") ? (t17 = (0, import_jsx_runtime2.jsx)(RevisionNotFoundBanner, {}), t18 = (0, import_jsx_runtime2.jsx)(ReferenceChangedBanner, {}), t19 = (0, import_jsx_runtime2.jsx)(DeprecatedDocumentTypeBanner, {}), t20 = (0, import_jsx_runtime2.jsx)(CanvasLinkedBanner, {}), t21 = (0, import_jsx_runtime2.jsx)(DeletedDocumentBanners, {}), t22 = (0, import_jsx_runtime2.jsx)(UnpublishedDocumentBanner, {}), $[55] = t17, $[56] = t18, $[57] = t19, $[58] = t20, $[59] = t21, $[60] = t22) : (t17 = $[55], t18 = $[56], t19 = $[57], t20 = $[58], t21 = $[59], t22 = $[60]);
    const t23 = (displayed == null ? void 0 : displayed._id) ?? documentId;
    let t24;
    $[61] !== isPinnedDraftOrPublish || $[62] !== t23 ? (t24 = (0, import_jsx_runtime2.jsx)(OpenReleaseToEditBanner, { documentId: t23, isPinnedDraftOrPublished: isPinnedDraftOrPublish }), $[61] = isPinnedDraftOrPublish, $[62] = t23, $[63] = t24) : t24 = $[63];
    let t25;
    $[64] !== t152 || $[65] !== t16 || $[66] !== t24 ? (t25 = (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      t152,
      t16,
      t17,
      t18,
      ...
      t22,
      t24
    ] }), $[64] = t152, $[65] = t16, $[66] = t24, $[67] = t25) : t25 = $[67], t12 = t25;
  }
  const banners = t12, showFormView = features.resizablePanes || !showInspector;
  let t13;
  $[68] !== activeViewNode || $[69] !== banners || $[70] !== documentScrollElement || $[71] !== footer || $[72] !== formViewHidden || $[73] !== inspectDialog || $[74] !== layoutCollapsed || $[75] !== margins || $[76] !== portalElement || $[77] !== showFormView ? (t13 = showFormView && (0, import_jsx_runtime2.jsxs)(Flex, { height: "fill", direction: "column", width: "fill", flex: 2, children: [
    ...
    footer
  ] }), $[68] = activeViewNode, $[69] = banners, $[70] = documentScrollElement, $[71] = footer, $[72] = formViewHidden, $[73] = inspectDialog, $[74] = layoutCollapsed, $[75] = margins, $[76] = portalElement, $[77] = showFormView, $[78] = t13) : t13 = $[78];
  let t14;
  $[79] !== documentId || $[80] !== rootElement || $[81] !== schemaType || $[82] !== showInspector ? (t14 = showInspector && (0, import_jsx_runtime2.jsx)(BoundaryElementProvider, { element: rootElement, children: (0, import_jsx_runtime2.jsx)(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[79] = documentId, $[80] = rootElement, $[81] = schemaType, $[82] = showInspector, $[83] = t14) : t14 = $[83];
  let t15;
  return $[84] !== t13 || $[85] !== t14 ? (t15 = (0, import_jsx_runtime2.jsx)(PaneContent, { children: (0, import_jsx_runtime2.jsxs)(Flex, { height: "fill", children: [
    t13,
    t14
  ] }) }), $[84] = t13, $[85] = t14, $[86] = t15) : t15 = $[86], t15;
};
...
function PublishedEventMenu(t0) {
  ...
  const $ = (0, import_react_compiler_runtime.c)(41), {
    ...
    t: tCore
  } = useTranslation2(), portalContext = usePortal(), {
    params,
    setParams
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react2.lazy)(() => import("./index3-RAI55N2L.js")),
...
@tanstack/react-table/build/lib/index.mjs:
  (**
     ...
     *)
*/
//# sourceMappingURL=chunk-SX3FDGEU.js.map
